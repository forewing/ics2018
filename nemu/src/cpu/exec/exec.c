...
opcode_entry opcode_table [512] = {
  ...
  /* 0x80 */	IDEXW(I2E, gp1, 1), IDEX(I2E, gp1), EMPTY, IDEXW(gp1_SI2E, gp1, 1),
  /* 0x84 */	IDEXW(G2E, test, 1), IDEX(G2E, test), IDEXW(G2E, xchg, 1), IDEX(G2E, xchg),
  ...
  /* 0x90 */	EX(nop), IDEX(xchg_ar, xchg), IDEX(xchg_ar, xchg), IDEX(xchg_ar, xchg),
  /* 0x94 */	IDEX(xchg_ar, xchg), IDEX(xchg_ar, xchg), IDEX(xchg_ar, xchg), IDEX(xchg_ar, xchg),
  /* 0x98 */	IDEX(cbw_a, cbw), IDEX(cwd_a2d, cwd), EMPTY, EMPTY,
